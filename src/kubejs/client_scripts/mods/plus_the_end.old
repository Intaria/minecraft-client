onEvent('jei.hide.items', event => {
    event.hide([
        'plus_the_end:endronium_sword',
        'plus_the_end:endronium_pickaxe',
        'plus_the_end:endronium_shovel',
        'plus_the_end:endronium_axe',
        'plus_the_end:endronium_hoe',
        'plus_the_end:endronium_helmet',
